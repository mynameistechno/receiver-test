...
In general, contributors should develop on branches based off of `main` and pull requests should be made against `main`. Contributions may not be accepted on all branches. Please see the [README](README.md#branches) for branch descriptions.
